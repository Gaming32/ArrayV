...
final public class ooPQuicksort extends Sort {
    ...
    private void ooPquickSort(int[] array, int[] swap, int start, int end, boolean forwards, boolean fromSwap) {       
        ...
        if(end-start>10){
            if(array[a]>array[b]){temp = a;a = b;b = temp;}
            Highlights.markArray(1, a);
            Highlights.markArray(2, b);
            Delays.sleep(0.25); 
            if(array[c]>array[d]){temp = c;c = d;d = temp;}
            Highlights.markArray(1, c);
            Highlights.markArray(2, d);
            Delays.sleep(0.25); 
            if(array[b]>array[d]){temp = b;b = d;d = temp;}
            Highlights.markArray(1, b);
            Highlights.markArray(2, d);
            Delays.sleep(0.25); 
            if(array[a]>array[c]){temp = a;a = c;c = temp;}
            Highlights.markArray(1, a);
            Highlights.markArray(2, c);
            Delays.sleep(0.25); 
            if(array[c]>array[e]){temp = c;c = e;e = temp;}
            Highlights.markArray(1, c);
            Highlights.markArray(2, e);
            Delays.sleep(0.25); 
            if(array[b]>array[c]){temp = b;b = c;c = temp;}
            Highlights.markArray(1, b);
            Highlights.markArray(2, c);
            Delays.sleep(0.25); 
        }
