...
final public class StudioOptiStoogeSort extends Sort {
    public StudioOptiStoogeSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        
        this.setSortListName("Studio Opti. Stooge");
