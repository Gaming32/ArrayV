...
SortPrompt.setSortThreadForCategory(CATEGORY) {
    runGroup(18) {
        category = CATEGORY
        ...
        run ClassicGravitySort with 1024.numbers and 1.delay
        run StaticSort with 2048.numbers and 1.delay
        run IndexSort with 2048.numbers and 1.delay
        ...
        run FlashSort with 2048.numbers and 1.delay
        run BinaryQuickSortIterative with 2048.numbers and 1.delay
        run BinaryQuickSortRecursive with 2048.numbers and 1.delay
        run StacklessBinaryQuickSort with 2048.numbers and 1.delay
        run ShatterSort with 2048.numbers, 128.buckets and 1.delay
